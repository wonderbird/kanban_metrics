...
from iterative_metrics.adapters.inbound.find_work_items_by_workflow_steps import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [3, 0],
            "2_workflow_steps_3_work_items_width_464px_height_1780px_resolution_144dpi.png",
        ),
    ],
    ids=[
        ...
        "2 workflow steps with 3 and 0 work items",
    ],
)
